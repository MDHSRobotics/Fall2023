...
public class MoveForklift extends CommandBase {
    ...
    public void execute() {
        ...
        m_forklift.move("Extender", extenderPower * extenderSpeedEntry.getDouble(1.0), 0.05);
        m_forklift.move("Elevator", elevatorPower * elevatorSpeedEntry.getDouble(1.0), 0.05);
